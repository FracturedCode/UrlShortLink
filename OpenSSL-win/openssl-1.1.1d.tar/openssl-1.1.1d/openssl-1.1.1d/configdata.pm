...
our %config = (
  ...
  MT => "mt",
  MTFLAGS => [ "-nologo" ],
  PERL => "E:\\Programs\\Perl\\perl\\bin\\perl.exe",
  RC => "rc",
  RCFLAGS => [  ],
  afalgeng => "",
  b32 => "0",
  ...
  prefix => "E:\\repos\\UrlSL\\OpenSSL-win",
  processor => "",
